...
Celeste pulls elements of a lot of games. It gets the quick gameplay loop (die fast, spawn faster), and having a small and dynamic character from <span class="meat"><a href="https://store.steampowered.com/app/40800/Super_Meat_Boy/">SUPER MEAT BOY</a></span> <small>(what a cool font)</small> but I feel like its tile-based levels are more of a <span class="mario"><a href="https://supermariomaker.nintendo.com/">SUPER MARIO MAKER</a></span> *vibe*. But it also adds its own spirit in the way of the movement by adding a crucial element used in almost all screens. **The dash.**
